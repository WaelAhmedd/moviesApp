 ...
 */
public class TopRated extends Fragment implements MainAdapter.ListItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainList=view.findViewById(R.id.rv_top_rated_list);
